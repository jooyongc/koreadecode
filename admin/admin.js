const { app } = firebase;
const { getAuth, signInWithEmailAndPassword, onAuthStateChanged, signOut } = firebase.auth;
const { getFirestore, collection, addDoc, getDocs, doc, getDoc, updateDoc, deleteDoc, serverTimestamp, query, orderBy, where } = firebase.firestore;
const { getStorage, ref, uploadBytes, getDownloadURL } = firebase.storage;

// Note: firebase-config.js should be loaded before this script.
// It provides the `firebaseConfig` global variable.
